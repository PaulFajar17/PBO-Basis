...
def login_window():
    ...
    bg = Image.open("./assets/LOGIN (1).png").filter(ImageFilter.GaussianBlur(10))
    ...
    def login():
        ...
        if result:
            ...
            window.destroy()  # Tutup jendela login
            # Di sini Anda bisa memanggil fungsi aplikasi utama
            # main_app()
        else:
